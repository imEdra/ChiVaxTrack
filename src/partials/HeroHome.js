        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="text-center pb-12 md:py-24 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <a href="https://www.zocdoc.com/vaccine" className="btn-sm bg-clip-text font-extrabold text-transparent bg-gradient-to-r from-teal-500 to-blue-500 ml-3" data-aos="zoom-y-out" data-aos-delay="300">
